export default require => {
  ...
  var BinaryTreeModulePlugin = class extends (_a = o3, _make_empty_tree_dec = [n2([], E.EMPTY_LIST)], _make_tree_dec = [n2([E.OPAQUE, E.LIST, E.LIST], E.PAIR)], _is_tree_dec = [n2([], E.BOOLEAN)], _is_empty_tree_dec = [n2([], E.BOOLEAN)], _entry_dec = [n2([E.LIST], E.OPAQUE)], _left_branch_dec = [n2([E.LIST], E.LIST)], _right_branch_dec = [n2([E.LIST], E.LIST)], _a) {
    constructor() {
      super(...arguments);
