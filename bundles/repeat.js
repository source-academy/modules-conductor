export default require => {
  ...
  var RepeatModulePlugin = class extends (_a = o2, _repeat_dec = [n([A.CLOSURE, A.NUMBER], A.CLOSURE)], _twice_dec = [n([A.CLOSURE], A.CLOSURE)], _thrice_dec = [n([A.CLOSURE], A.CLOSURE)], _a) {
